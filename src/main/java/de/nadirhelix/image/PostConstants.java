...
public class PostConstants {
	...
	public static final String BACKGROUND_IMAGE_PATH = buildPath(true, "images", "background");
	...
	public static final String DEFAULT_SUBTEXT_FONT = buildPath(false, "font", "subtextFont.vlw");
