...
public class TextImage implements ComponentData {
	...
	/**
	 * @see de.nadirhelix.image.dto.ComponentData#getPosX()
	 */
	@Override
	public int getPosX() {
		return posX;
	...
	/**
	 * @see de.nadirhelix.image.dto.ComponentData#getPosY()
	 */
	@Override
	public int getPosY() {
		return posY;
	...
	/**
	 * @see de.nadirhelix.image.dto.ComponentData#getRotation()
	 */
	@Override
